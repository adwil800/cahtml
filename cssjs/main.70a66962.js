...
}(
{
	...
	juYr: function (t, e, n)
	{
		...
		}("undefined" != typeof window ? window : this, function (n, r)
		{
			...
			}, yt.extend = yt.fn.extend = function ()
			{
				...
				for ("boolean" == typeof s && (u = s, s = arguments[a] ||
					...
					if (null != (t = arguments[a]))
						for (e in t) n = s[e], i = t[e], s !== i && (u && i && (yt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && yt.isPlainObject(n) ? n :
			...
			{
				t = "string" == typeof t ? p(t) : yt.extend(
				{}, t);
				var e, n, i, o, r = [],
					s = [],
					a = -1,
				...
				add: function (t, e, n, i, o)
				{
					...
					if (m)
						for (n.handler && (r = n, n = r.handler, o = r.selector), o && yt.find.matchesSelector(Zt, o), n.guid || (n.guid = yt.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e)
							...
							}), e = (e || "").match(It) || [""], u = e.length; u--;) a = ne.exec(e[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (p = yt.event.special[d] ||
						{}, d = (o ? p.delegateType : p.bindType) || d, p = yt.event.special[d] ||
						{}, c = yt.extend(
						{
							type: d,
							origType: g,
						...
						for (e = (e || "").match(It) || [""], u = e.length; u--;)
							if (a = ne.exec(e[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d)
							{
								for (p = yt.event.special[d] ||
									{}, d = (i ? p.delegateType : p.bindType) || d, f = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--;) c = f[r], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (f.splice(r, 1), c.selector && f.delegateCount--, p.remove && p.remove.call(t, c));
			...
			yt.extend(yt.event,
			{
				trigger: function (t, e, i, o)
				{
						...
						{}, o || !p.trigger || !1 !== p.trigger.apply(i, e)))
					{
						...
						for (r = 0;
							(s = f[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : p.bindType || d, c = (Ht.get(s, "events") ||
						{})[t.type] && Ht.get(s, "handle"), c && c.apply(s, e), (c = u && s[u]) && c.apply && Rt(s) && (t.result = c.apply(s, e), !1 === t.result && t.preventDefault());
			...
			Ue.href = $e.href, yt.extend(
			{
				...
				ajax: function (t, e)
				{
					...
					{};
					var o, r, s, a, l, u, c, p, f, d, h = yt.ajaxSetup(
						{}, e),
						g = h.context || h,
			...
			}), yt.expr.pseudos.animated = function (t)
			{
				...
				setOffset: function (t, e, n)
				{
					var i, o, r, s, a, l, u, c = yt.css(t, "position"),
						p = yt(t),
						f = {};
					"static" === c && (t.style.position = "relative"), a = p.offset(), r = yt.css(t, "top"), l = yt.css(t, "left"), u = ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1, u ? (i = p.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), yt.isFunction(e) && (e = e.call(t, n, yt.extend(
					{}, a))), null != e.top && (f.top = e.top - a.top + s), null != e.left && (f.left = e.left - a.left + o), "using" in e ? e.using.call(t, f) : p.css(f)
				}
			}, yt.fn.extend(
			{
				offset: function (t)
				...
				var o = Object.assign || function (t)
					...
					l = function ()
					{
						...
						return r(t, [
						{
							...
							value: function (t, e, n)
							{
								if (t.el = "string" == typeof n ? document.querySelector(n) : n, t.options = o(
									{}, a.default, e), t.isInput = "input" === t.el.tagName.toLowerCase(), t.attr = t.options.attr, t.bindInputFocusEvents = t.options.bindInputFocusEvents, t.showCursor = !t.isInput && t.options.showCursor, t.cursorChar = t.options.cursorChar, t.cursorBlinking = !0, t.elContent = t.attr ? t.el.getAttribute(t.attr) : t.el.textContent, t.contentType = t.options.contentType, t.typeSpeed = t.options.typeSpeed, t.startDelay = t.options.startDelay, t.backSpeed = t.options.backSpeed, t.smartBackspace = t.options.smartBackspace, t.backDelay = t.options.backDelay, t.fadeOut = t.options.fadeOut, t.fadeOutClass = t.options.fadeOutClass, t.fadeOutDelay = t.options.fadeOutDelay, t.isPaused = !1, t.strings = t.options.strings.map(function (t)
									{
										return t.trim()
